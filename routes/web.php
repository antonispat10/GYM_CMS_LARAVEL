...
Route::group([ 'middleware' => 'roles:admin' ], function () {
    ...
    Route::delete('/admin/delete/exerciselist', [
        'as'   => 'exerciselist_delete_array',
        'uses' => 'AdminExerciseListController@exerciselist_delete_array',
    ]);


    Route::get('/admin/weight', [
        'as'   => 'weight',
        'uses' => 'AdminUsersController@weight',
    ]);
